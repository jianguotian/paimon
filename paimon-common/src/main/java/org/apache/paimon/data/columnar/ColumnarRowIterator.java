...
public class ColumnarRowIterator extends RecyclableIterator<InternalRow>
     ...
     *
     * <p>Subclasses which expose a native bundle should override this method and fall back to an
     * ordinary vectorized iterator when the final output schema is incompatible with that bundle.
     */
    public ColumnarRowIterator mapping(
